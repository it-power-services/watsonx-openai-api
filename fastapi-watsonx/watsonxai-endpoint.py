...
def get_watsonx_models():
    try:
        ...
        params = {
            ...
            "filters": "function_text_generation,!lifecycle_withdrawn:and,!modelid_ibm/granite-3-2b-instruct:and",
            "limit": 200,
        }
        response = requests.get(WATSONX_MODELS_URL, headers=headers, params=params)
...
async def watsonx_completions(request: Request):
    ...
    openai_response = {
        ...
        "usage": {
            ...
            "total_tokens": results[0].get("input_token_count", 5)
            + results[0].get("generated_token_count", 7),
        },
    }
